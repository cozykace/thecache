...
for t in map_test roundtrip_test maptie_test restore_test rev_test catmeta_test tomb_test deck_parity checkinlog_test simplefin_test webmoney_parity burn_test catkey_test debt_test manual_test annual_test runway_test; do
