...
for t in merge_test authored_test livelock_test profile_test profilecard_test timer_test deck_test things_test forms_test logderive_test crypto_interop_test keybox_test vaultmigrate_test social_test routine_test cal_test deckday_test escape_test notifs_test bugcredit_test resetpw_test webmoney_test brandkit_test; do
