...
for t in merge_test authored_test livelock_test profile_test timer_test deck_test things_test forms_test logderive_test crypto_interop_test social_test routine_test cal_test deckday_test escape_test notifs_test bugcredit_test; do
