...
- **No old account left without a net** — if your cache predates recovery files, it used to have none: your passphrase *was* the key, so forgetting it meant losing everything. Now the next time you open that cache with your passphrase, it's quietly upgraded and a **recovery file** downloads for you — with a calm heads-up, not a scary popup. It stays zero-knowledge (only you can open it), your passphrase keeps working exactly as before, and if anything hiccups the upgrade just doesn't happen — your cache is never left half-changed. You don't do anything special; simply opening your cache is enough.
