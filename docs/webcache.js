...
(function () {
  ...
  var W_INTERNAL = ["money.cloud", "money.cloudKey", "money.cloudPaused", "money.deviceId", "money.__lmeta", "money.dockMobile", "money.zoom", "money.gutter", "money.sidebar", "money.sidebarWidth", "money.statsScroll", "money.icons.collapsed", "money.balExpanded", "money.settings", "money.connect", "money.wiki", "money.timerRun", "money.deckDay", "money.dms", "money.simplefin", "money.brandkit", "money.brandkitApply", "money.deckRev"];   // deckDay siloed per device; dms never rides the vault; simplefin = the browser bank credential (device-local bearer secret, never in the vault); brandkit = device MIRROR of the COMPANY cache's kit (never the founder's own vault); brandkitApply = per-device "apply live" toggle; deckRev RETIRED — MUST match app.js DEVICE_LOCAL_KEYS or it'd sync as a generic key and churn
